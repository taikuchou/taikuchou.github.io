...
function getDiv(dict) {
    ...
    addTwoColunmnListRow(formBox, dict, "Review 1", "Review 2", "CHANNELS", "EFFECT", "•", "•")
    addTwoColunmnListRow(formBox, dict, "Others", "Summary", "LITERAL_ENGLISH", "ACTIONS_INDICATIONS", "•", "•")
    return main
}
