...
function showDafan(data){
    ...
    addTwoColunmnTextRow(formBox, data, "Dosage", "Common Name", "DOSAGE", "COMMON_NAME")
    addTwoColunmnTextRow(formBox, data, "Channels", "Literal English", "CHANNELS", "LITERAL_ENGLISH")
    ...
    // addTwoColunmnTextRow(formBox, data, "Channels", "Latin Name", "CHANNELS", "LATIN_NAME")
