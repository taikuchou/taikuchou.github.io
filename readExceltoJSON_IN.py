...
def parseHFAll(sourceFile):
    ...
    url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQz1NwSyWlZ7opb4JSlc6_ibmpXeLwiedwSO4RQdtVO1fgvQuxOelcOtjk3G7qTnSmFuCeiQ7AZAd7x/pub?output=xlsx"
    ...
    print("parseINAll done!")


# url = "https://docs.google.com/spreadsheets/d/16A7B6jvWd7C430uVdVoKYRSK_WlMjcnrSgHnegnHQXY/edit?gid=0#gid=0"
