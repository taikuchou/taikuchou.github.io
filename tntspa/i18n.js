...
const translations = {
  ...
  "zh-CN": {
    ...
    "checklist.task.prep2": "准备卷位：蟹肉碎、青瓜、牛油果、炸虾",
    "checklist.task.prep3": "",
    "checklist.task.prep4": "",
    "checklist.task.during1": "开始做手卷：先切牛油果",
    "checklist.task.during2": "依「卷1」早上卷 74 份寿司",
    ...
    "checklist.task.post3": "确认：海苔（大）、海苔（小）、芝麻、擦手纸 是否足够",
    "checklist.task.post4": "补鱼子与蟹肉碎",
    "checklist.task.post5": "打扫所有厨具",
    "checklist.task.post6": "拆寿司机零件并清洗",
    "checklist.task.post7": "",
    "checklist.task.post8": "",
    "checklist.task.post9": "",
    "checklist.task.post10": "",
  ...
  "en": {
    ...
    "checklist.task.prep1": "In the morning, mix three pots of sushi vinegar rice (add leftover vinegar rice from the previous day).",
    "checklist.task.prep2": "Prepare rolling station: shredded crab meat, cucumber, avocado, fried shrimp.",
    "checklist.task.prep3": "",
    "checklist.task.prep4": "",
    "checklist.task.during1": "Start making hand rolls: slice the avocado first.",
    "checklist.task.during2": "Follow 'Roll 1' and make 74 sushi rolls in the morning.",
    ...
    "checklist.task.post3": "Check: ensure large seaweed sheets, small seaweed sheets, sesame seeds, and hand wipes are sufficient.",
