...
const translations = {
  "zh-TW": {
    ...
    "ing.egg": "蛋",
    "ing.tunaSashimi": "吞拿魚刺身切碎（少量拉差醬拌）80g",
    "ing.californiaGreenGrass": "(2號反卷 / 綠草版)",
    "ing.salmonSashimi": "三文魚刺身切碎（少量拉差醬拌）80g，加天婦羅碎",
    ...
    "instruction.roll4Type3": "第四條(3號正)：青瓜 30g、黃蘿蔔 30g、紅椒絲 20g、牛油果 20g、胡蘿蔔絲 15g、生菜 2片",
    "instruction.note": "備註：千島壽司盤可加紅魚子",

    // Checklist Items
    "checklist.task.prep1": "一早拌三鍋醋飯（加入前一天剩餘的醋飯）",
    "checklist.task.prep2": "準備卷位：刀、砧板、蟹肉碎、青瓜、牛油果、炸蝦",
    "checklist.task.prep3": "安裝與上油壽司機零件",
    "checklist.task.prep4": "桌面鋪保鮮膜、壽司竹卷與托盤包覆保鮮膜",
    "checklist.task.during1": "開始做手捲：先切牛油果5顆",
    "checklist.task.during2": "依「卷1」卷壽司",
    ...
    "checklist.task.post6": "壽司竹卷與托盤包覆保鮮膜",
    "checklist.task.post7": "拆壽司機零件與清洗",
    ...
    "checklist2.task.prep2": "準備卷位：刀、砧板",
    "checklist2.task.prep3": "記錄兩張表：出餐表、醋飯酸鹼度（8:30／10:30／14:30）",
    "checklist2.task.prep4": "9:30-9:40 送三文魚 + 兩份烤雞至熱廚部加熱",
    "checklist2.task.during1": "開始做手捲：先切牛油果5顆",
    "checklist2.task.during2": "依「卷2」卷壽司",
    "checklist2.task.during3": "9:30-9:40 送三文魚 + 兩份烤雞至熱廚部加熱",
    "checklist2.task.during4": "10:30–10:40 準備便當：6 三文魚／6 鰻魚／12 烤雞",
    "checklist2.task.during5": "補醬料與玉米粒，視狀況做冷飯與小菜",
    "checklist2.task.during6": "檢查庫存（含冷凍櫃），適當品項移至冷藏；庫存含：玉子燒／雞肉／鰻魚；冷藏含：薑片／雞汁",
    "checklist2.task.during7": "確認下午便當素材：3 條鰻魚(1 盒)、3 盒雞腿排(1.5袋)",
    "checklist2.task.during8": "煮三鍋飯：2 白飯 + 1 壽司飯（視狀況可以減少）",
    "checklist2.task.during9": "煮完飯回查便當，逾時貼折價標籤後，休息吃飯",
    "checklist2.task.post1": "拌一鍋醋飯，視狀況做冷飯與小菜",
    "checklist2.task.post2": "檢查庫存（含冷凍櫃），適當品項移至冷藏；庫存含：玉子燒／雞肉／鰻魚；冷藏含：薑片／雞汁",
    "checklist2.task.post3": "14:30 送 3 盒烤雞 + 1 盒三文魚給後廚（炸／加熱），請廚師多準備半盤西蘭菜",
    "checklist2.task.post4": "製作下午便當：6 三文魚／6 鰻魚／12+6(平日) 烤雞",
    "checklist2.task.post5": "準備明日：檢查鰻魚片／雞肉片；至少切 2 盒雞肉；冷藏保有 3 包雞塊、6 份鰻魚",
    "checklist2.task.post6": "確認：雞扒,鰻魚,米,玉米罐頭,燒雞汁是否足夠，若不足，向 Toby 申請",
    "checklist2.task.post7": "補醬料與玉米粒",
    "checklist2.task.post8": "記錄兩張表：出餐表、醋飯酸鹼度",
  ...
  "zh-CN": {
    ...
    "ing.egg": "蛋",
    "ing.tunaSashimi": "吞拿鱼刺身切碎（少量拉差酱拌）80g",
    "ing.californiaGreenGrass": "(2号反卷 / 绿草版)",
    "ing.salmonSashimi": "三文魚刺身切碎（少量拉差醬拌）80g，加天妇罗碎",
    ...
    "note.salmonSashimi": "三文魚刺身切碎（少量拉差酱拌），加天妇罗碎",
    ...
    "instruction.roll4Type3": "第四条(3号正)：青瓜 30g、黄萝卜 30g、红椒丝 20g、牛油果 20g、胡萝卜丝 15g、生菜 2片",
    "instruction.note": "备注：千岛寿司盘可加红鱼子",

    // Checklist Items (Simplified Chinese)
    "checklist.task.prep1": "一早拌三锅醋饭（加入前一天剩余的醋饭）",
    "checklist.task.prep2": "准备卷位：刀、砧板、蟹肉碎、青瓜、牛油果、炸虾",
    "checklist.task.prep3": "安装与上油寿司机零件",
    "checklist.task.prep4": "桌面铺保鲜膜、寿司竹卷与托盘包覆保鲜膜",
    "checklist.task.during1": "开始做手卷：先切5颗牛油果",
    "checklist.task.during2": "依「卷1」卷寿司",
    ...
    "checklist.task.during8": "",
    "checklist.task.post1": "下午备寿司料：红椒、黄萝卜、青瓜条(15条)、胡萝卜丝、青菜",
    ...
    "checklist.task.post6": "寿司竹卷与托盘包覆保鲜膜",
    "checklist.task.post7": "拆寿司机零件并清洗",
    "checklist.task.post8": "",
    "checklist.task.post9": "",
    "checklist.task.post10": "",
    "checklist.task.post11": "",
    ...
    "checklist2.task.prep2": "准备卷位：刀、砧板",
    "checklist2.task.prep3": "记录两张表：出餐表、醋饭酸碱度（8:30／10:30／14:30）",
    "checklist2.task.prep4": "9:30-9:40 送三文鱼 + 两份烤鸡至热厨部加热",
    "checklist2.task.during1": "开始做手卷：先切5颗牛油果",
    "checklist2.task.during2": "依「卷2」卷寿司",
    "checklist2.task.during3": "9:30-9:40 送三文鱼 + 两份烤鸡至热厨部加热",
    "checklist2.task.during4": "10:30–10:40 准备便当：6 三文鱼／6 鳗鱼／12 烤鸡",
    "checklist2.task.during5": "补酱料与玉米粒，视状况做冷饭与小菜",
    "checklist2.task.during6": "检查库存（含冷冻柜），适当品项移至冷藏；库存含：玉子烧／鸡肉／鳗鱼；冷藏含：姜片／鸡汁",
    "checklist2.task.during7": "确认下午便当素材：3 条鳗鱼(1 盒)、3 盒鸡腿排(1.5袋)",
    "checklist2.task.during8": "煮三锅饭：2 白饭 + 1 寿司饭（视状况可以减少）",
    "checklist2.task.during9": "煮完饭回查便当，逾时贴折价标签后，休息吃饭",
    "checklist2.task.post1": "拌一锅醋饭，视状况做冷饭与小菜",
    "checklist2.task.post2": "检查库存（含冷冻柜），适当品项移至冷藏；库存含：玉子烧／鸡肉／鳗鱼；冷藏含：姜片／鸡汁",
    "checklist2.task.post3": "14:30 送 3 盒烤鸡 + 1 盒三文鱼给后厨（炸／加热），请厨师多准备半盘西兰花",
    "checklist2.task.post4": "制作下午便当：6 三文鱼／6 鳗鱼／12+6(平日) 烤鸡",
    "checklist2.task.post5": "准备明日：检查鳗鱼片／鸡肉片；至少切 2 盒鸡肉；冷藏保有 3 包鸡块、6 份鳗鱼",
    "checklist2.task.post6": "确认：鸡扒、鳗鱼、米、玉米罐头、烧鸡汁是否足够，若不足，向 Toby 申请",
    "checklist2.task.post7": "补酱料与玉米粒",
    "checklist2.task.post8": "记录两张表：出餐表、醋饭酸碱度",
  ...
  "en": {
    ...
    "ing.egg": "Egg",
    "ing.tunaSashimi": "Chopped tuna sashimi (mixed with a small amount of Sriracha sauce) 80g",
    "ing.californiaGreenGrass": "(Type 2 Inside-Out / Green Grass Version)",
    "ing.salmonSashimi": "Chopped Salmon sashimi (mixed with a small amount of Sriracha sauce) 80g, mixed with tempura flakes",
    ...
    "note.salmonSashimi": "Minced Salmon Sashimi (with Sriracha), mixed with tempura flakes",
    ...
    "instruction.roll4Type3": "Roll 4 (Type 3 Regular): Cucumber 30g, Yellow Pickle 30g, Red Pepper 20g,  Avocado 20g, Carrot 15g, Lettuce 2 leaves",
    "instruction.note": "Note: Thousand Island platter can add red tobiko",


    // Checklist Items
    "checklist.task.prep1": "In the morning, mix three pots of sushi rice (include leftover rice from the previous day)",
    "checklist.task.prep2": "Prepare rolling station: knife, cutting board, minced crab meat, cucumber, avocado, fried shrimp",
    "checklist.task.prep3": "Assemble and oil sushi machine parts",
    "checklist.task.prep4": "Cover table with plastic wrap; wrap bamboo mats and trays with plastic film",
    "checklist.task.during1": "Start making hand rolls: cut 5 avocados first",
    "checklist.task.during2": "Roll sushi according to 'Roll 1'",
    "checklist.task.during3": "Check ingredients: red pepper, yellow radish, cucumber strips, shredded carrot, and greens are sufficient",
    "checklist.task.during4": "Steam and heat salmon",
    "checklist.task.during5": "Take a lunch break after finishing rolling",
    "checklist.task.during6": "Complete unfinished 'Roll 2' sushi",
    "checklist.task.during7": "Second batch: California 20, Salmon Avocado 10, Small Salmon 10, Large Shrimp 4, Crispy Dragon 2",
    "checklist.task.during8": "",
    "checklist.task.post1": "Prepare afternoon sushi ingredients: red pepper, yellow radish, cucumber strips (15 pcs), shredded carrot, greens",
    "checklist.task.post2": "Confirm cooked salmon",
    "checklist.task.post3": "Confirm: large nori, small nori, sesame seeds, paper towels are sufficient",
    "checklist.task.post4": "Refill fish roe and minced crab meat",
    "checklist.task.post5": "Clean all kitchen utensils",
    "checklist.task.post6": "Wrap sushi bamboo mats and trays with plastic film",
    "checklist.task.post7": "Disassemble and clean sushi machine parts",
    "checklist.task.post8": "",
    "checklist.task.post9": "",
    "checklist.task.post10": "",
    "checklist.task.post11": "",
    ...
    // Checklist 2 Items
    "checklist2.task.prep1": "In the morning, mix three pots of sushi rice (include leftover rice from the previous day)",
    "checklist2.task.prep2": "Prepare rolling station: knife, cutting board",
    "checklist2.task.prep3": "Record two forms: serving record and vinegar rice pH levels (8:30 / 10:30 / 14:30)",
    "checklist2.task.prep4": "9:30–9:40 Deliver salmon + two portions of grilled chicken to the hot kitchen for reheating",
    "checklist2.task.during1": "Start making hand rolls: cut 5 avocados first",
    "checklist2.task.during2": "Roll sushi according to 'Roll 2'",
    "checklist2.task.during3": "9:30–9:40 Deliver salmon + two portions of grilled chicken to the hot kitchen for reheating",
    "checklist2.task.during4": "10:30–10:40 Prepare lunch boxes: 6 salmon / 6 eel / 12 grilled chicken",
    "checklist2.task.during5": "Refill sauces and corn kernels, prepare cold rice and side dishes if needed",
    "checklist2.task.during6": "Check inventory (including freezer), move suitable items to fridge; inventory includes: tamago, chicken, eel; fridge includes: ginger slices, chicken sauce",
    "checklist2.task.during7": "Confirm afternoon bento ingredients: 3 eels (1 box), 3 boxes chicken thighs (1.5 bags)",
    "checklist2.task.during8": "Cook three pots of rice: 2 white rice + 1 sushi rice (reduce if necessary)",
    "checklist2.task.during9": "After cooking rice, check bento boxes; attach discount labels to overdue ones, then take lunch break",
    "checklist2.task.post1": "Mix one pot of sushi rice, prepare cold rice and side dishes as needed",
    "checklist2.task.post2": "Check inventory (including freezer), move suitable items to fridge; inventory includes: tamago, chicken, eel; fridge includes: ginger slices, chicken sauce",
    "checklist2.task.post3": "At 14:30 deliver 3 boxes of grilled chicken + 1 box of salmon to back kitchen (for frying/heating); ask chef to prepare half a tray of broccoli",
    "checklist2.task.post4": "Prepare afternoon lunch boxes: 6 salmon / 6 eel / 12+6 (weekday) grilled chicken",
    "checklist2.task.post5": "Prepare for tomorrow: check eel and chicken fillets; cut at least 2 boxes of chicken; keep 3 bags of chicken chunks and 6 portions of eel in fridge",
    "checklist2.task.post6": "Confirm chicken steak, eel, rice, canned corn, roasted chicken sauce are sufficient; if not, request from Toby",
    "checklist2.task.post7": "Refill sauces and corn kernels",
    "checklist2.task.post8": "Record two forms: serving record and vinegar rice pH level",
    "checklist2.task.post9": "Clean all kitchen utensils",
    "checklist2.task.post10": "Take photos and upload to the group",
    "checklist2.task.post11": "Confirm: aluminum lunch boxes, cold lunch containers, side dish boxes, and gloves are sufficient; if not, fill out the request form",
  }
};
